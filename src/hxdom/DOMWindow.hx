...
class DOMWindow extends EventTarget {
 ...
 object providing access to the offline resources for the window. */
	...
	public var indexedDB(default, null):js.html.idb.Factory;
...
">Requires Gecko 2.0</span>
 ...
 for more details.</dd> */
	...
	public function openDatabase (name:String, version:String, displayName:String, estimatedSize:Int, ?creationCallback:js.html.sql.DatabaseCallback):js.html.sql.Database {
	...
	public function requestFileSystem (type:Int, size:Int, successCallback:js.html.fs.FileSystemCallback, ?errorCallback:js.html.fs.ErrorCallback):Void {
	...
	public function resolveLocalFileSystemURL (url:String, successCallback:js.html.fs.EntryCallback, ?errorCallback:js.html.fs.ErrorCallback):Void {
