...
<code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Attribute/contentStyleType">contentStyleType</a></code> on the given <code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Element/svg">&lt;svg&gt;</a></code>
 element. */
	public var contentStyleType:String;
 ...
 element, the corresponding translation factor that takes into account user "magnification". */
	public var currentTranslate(default, null):Point;
...
<code><a rel="internal" href="https://developer.mozilla.org/en/SVG/Attribute/currentView" class="new">currentView</a></code> will correspond to the values from the SVG view specification fragment identifier</li> </ul> </li> </ul> */
	public var currentView(default, null):ViewSpec;
...
<code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Attribute/height">height</a></code> on the given <code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Element/svg">&lt;svg&gt;</a></code>
 element. */
	public var height(default, null):AnimatedLength;
	...
	public var pixelUnitToMillimeterX(default, null):Float;

	/** Corresponding size of a pixel unit along the y-axis of the viewport. */
	public var pixelUnitToMillimeterY(default, null):Float;
	...
	public var screenPixelToMillimeterX(default, null):Float;

	/** Corresponding size of a screen pixel along the y-axis of the viewport. */
	public var screenPixelToMillimeterY(default, null):Float;
...
<code><a rel="internal" href="https://developer.mozilla.org/en/SVG/Attribute/viewBox" class="new">viewBox</a></code>) or to a "custom" view (i.e., a hyperlink into a particular <code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Element/view">&lt;view&gt;</a></code>
 or other element). If the initial view is the "standard" view, then this attribute is false. If the initial view is a "custom" view, then this attribute is true. */
	public var useCurrentView(default, null):Bool;
...
<code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Attribute/width">width</a></code> on the given <code><a rel="custom" href="https://developer.mozilla.org/en/SVG/Element/svg">&lt;svg&gt;</a></code>
 element. */
	public var width(default,null):AnimatedLength;

	public var x(default,null):AnimatedLength;

	public var y(default,null):AnimatedLength;

	public function animationsPaused ():Bool {
		return null;
	}

	public function checkEnclosure (element:Element, rect:Rect):Bool {
		return null;
	}

	public function checkIntersection (element:Element, rect:Rect):Bool {
		return null;
	}

	public function createSVGAngle ():Angle {
		return null;
	}

	public function createSVGLength ():Length {
		return null;
	}

	public function createSVGMatrix ():Matrix {
		return null;
	}

	public function createSVGNumber ():Number {
		return null;
	}

	public function createSVGPoint ():Point {
		return null;
	}

	public function createSVGRect ():Rect {
		return null;
	}

	public function createSVGTransform ():Transform {
		return null;
	}
	...
	public function getEnclosureList (rect:Rect, referenceElement:Element):NodeList {
		return null;
	}

	public function getIntersectionList (rect:Rect, referenceElement:Element):NodeList {
		return null;
	}
	...
	public function setCurrentTime (seconds:Float):Void {
		
	}

	public function suspendRedraw (maxWaitMilliseconds:Int):Int {
		return null;
	}
	...
	public function unsuspendRedraw (suspendHandleId:Int):Void {
